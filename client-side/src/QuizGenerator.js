  ...
  return (
    <div>
      ...
      <div className="container">
        <h2 className="mt-3">Assessment Generator</h2>
        <div className="form-group">
          <label htmlFor="quizName">Assessment Name:</label>
          <input
            type="text"
        ...
        <div className="form-group">
          <label htmlFor="selectedTechnology">Select Subject:</label>
          <select
            className="form-control"
        ...
        {quiz.length > 0 && (
          <div>
            <h3 className="mt-3">Assessment Questions</h3>
